...
**1.** Execute Seatbetl with the argument TokenPrivileges
...
And finally we call the [CreateProcessFromParent()](https://learn.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa) function, passing the arguments of our parent process and the executable we want to launch. 
...
Matt Graeber together with Lee Christensen gave a talk in 2018 at blackhat => [slides](https://github.com/mattifestation/BHUSA2018_Sysmon/blob/master/Slides_Subverting_Sysmon.pdf)
...
```
-	More information https://specterops.io/wp-content/uploads/sites/3/2022/06/Subverting_Sysmon.pdf
