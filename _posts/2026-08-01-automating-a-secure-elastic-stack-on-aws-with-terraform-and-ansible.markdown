...
<div class="mermaid-wrapper">
  <pre class="mermaid">
flowchart TD
  Operator["Operator workstation"] --> Terraform["Terraform provisions AWS infrastructure"]
  Terraform --> EC2["EC2 instance + Elastic IP"]
  EC2 --> Ansible["Ansible configures the host"]
